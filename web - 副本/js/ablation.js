// Ablation playground — 3 toggles → live readout from metrics.ablation.
...
(function () {
  ...
  BrainTT.lazy(section, async () => {
    ...
    function render() {
      const r = findRow(state) || baseline;
    ...
    // Failure modes browser — render here so we share one DOM pass.
